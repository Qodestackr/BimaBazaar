...
import { Shield, AlertCircle, CheckCircle, Plus, Search, Filter } from 'lucide-react'
...
const POLICIES: PolicyItem[] = [
    { id: "1", vehicleReg: "KAA 123B", type: "Comprehensive", status: "active", expiryDate: "2024-12-31" },
    { id: "2", vehicleReg: "KBB 456C", type: "Third Party", status: "expiring", expiryDate: "2024-06-30" },
    { id: "3", vehicleReg: "KCC 789D", type: "Comprehensive", status: "expired", expiryDate: "2024-05-15" },
]
        ...
        <div className="w-full bg-white dark:bg-zinc-900/70 border border-zinc-100 dark:border-zinc-800 rounded-xl shadow-sm backdrop-blur-xl">
            <div className="p-4 border-b border-zinc-100 dark:border-zinc-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-50">{policies.length}</h1>
                </div>
