...
export function PaymentsManagement() {
    ...
    return (
        <div className="w-full max-w-md mx-auto bg-white dark:bg-zinc-900/70 border border-zinc-100 dark:border-zinc-800 rounded-xl shadow-sm backdrop-blur-xl">
            ...
            <div className="p-3">
                <h2 className="text-xs font-medium text-zinc-900 dark:text-zinc-100 mb-2">Recent Transactions</h2>
                    ...
                    {transactions.map((transaction) => (
                        ...
                        >
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <h3 className="text-xs font-medium text-zinc-900 dark:text-zinc-100">{transaction.description}</h3>
